...
import type { IFriendRequest, IFriends } from "../interface";
...
export default function HomePage() {
  ...
  const { data, isLoading: isLoadingFriends } = useQuery({
    queryKey: ["friends"],
  ...
  const { data: recommendedUsersData, isLoading: isLoadingUsers } = useQuery({
    queryKey: ["users"],
  ...
  const outgoingFriendReqs = outgoingFriendReqsData?.data as
    | IFriendRequest[]
    | undefined;
  ...
  useEffect(() => {
    ...
    if (outgoingFriendReqs && outgoingFriendReqs.length > 0) {
      outgoingFriendReqs.forEach((req: IFriendRequest) => {
